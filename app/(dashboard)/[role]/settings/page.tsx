...
import { changePasswordAction } from "@/src/actions/user.actions"
...
export default function SettingsPage() {
  ...
  const isGoogleUser = (user as any)?.isGoogleUser === true
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <Card className="rounded-[2.5rem] border-border shadow-sm bg-card overflow-hidden">
        ...
        <CardContent className="p-8">
          ...
          {/* Google User — Password change nahi kar sakta */}
          {isGoogleUser ? (
            <div className="flex flex-col items-center justify-center py-10 gap-4 text-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm mt-1">
                  Aap Google se login karte hain — password change karne ke liye<br />
                  apne Google account ki security settings use karein.
                </p>
              </div>
            </div>
          ) : (
